...
namespace IKVM.JdkUtil
{
    ...
    /// </summary>
    public readonly struct JdkVersion : IComparable<JdkVersion>
    {
        ...
        public static JdkVersion Parse(string value)
        {
            if (IsSimpleNumber(value.AsSpan()))
                return new JdkVersion([int.Parse(value)], null, null, null);
            ...
            return new JdkVersion(version.DrainToImmutable(), pre, build, optional);
        }
        ...
        public JdkVersion(ImmutableArray<int> version, string? pre, int? build, string? optional)
        {
            _version = version;
            _pre = pre;
            _build = build;
        ...
        {
            return obj is JdkVersion other && Equals(other);
        }
        ...
        /// <returns></returns>
        public readonly bool Equals(JdkVersion other)
        {
            return
        ...
        /// <summary>
        /// Compares this <see cref="JdkVersion"/> with <paramref name="other"/>.
        /// </summary>
        /// <param name="other"></param>
        /// <param name="ignoreOptional"></param>
        /// <returns></returns>
        readonly int CompareTo(JdkVersion other, bool ignoreOptional)
        {
        ...
        /// <summary>
        /// Compares the version value of this <see cref="JdkVersion"/> to <paramref name="other"/>.
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        readonly int CompareVersion(JdkVersion other)
        {
        ...
        /// <summary>
        /// Compares the pre value of this <see cref="JdkVersion"/> to <paramref name="other"/>.
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        readonly int ComparePre(JdkVersion other)
        {
            if (_pre is null)
            {
        ...
        /// <summary>
        /// Compares the build value of this <see cref="JdkVersion"/> to <paramref name="other"/>.
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        readonly int CompareBuild(JdkVersion obj)
        {
        ...
        /// <summary>
        /// Compares the optional value of this <see cref="JdkVersion"/> to <paramref name="other"/>.
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        readonly int CompareOptional(JdkVersion other)
        {
